...
export const lexwareSpec: LexwareApiCatalog = {
	...
	paths: {
		...
		'/v1/files': {
			post: { operationId: 'uploadFile', tags: ['files', 'documents', 'write'], summary: 'Upload a file', parameters: [{ name: 'type', in: 'query', type: 'string', enum: ['voucher'], description: 'File type/purpose. For bookkeeping files use voucher.' }], requestBody: { contentType: 'multipart/form-data', summary: 'Multipart upload with file field and type=voucher.' }, responses: documentResponses, docsUrl: 'https://developers.lexware.io/docs/#files-endpoint-upload-a-file' },
		},
		'/v1/files/{id}': {
